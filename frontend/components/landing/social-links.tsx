...
export default function SocialLinks() {
  const socialLinks = [
    {
      name: "Instagram",
      url: "https://instagram.com/el_berlin304",
      icon: (
    ...
    {
      name: "Facebook",
      url: "https://facebook.com/shyam.yemuka",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/shyam-yemuka-0aba06205",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "X (Twitter)",
      url: "https://twitter.com/ShyamYemuka304",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
