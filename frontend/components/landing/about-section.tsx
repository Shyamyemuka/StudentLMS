...
export default function AboutSection() {
  return (
    <section id="contact" className="py-24 bg-[#14181D]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:pr-8">
            <h3 className="text-2xl text-[#EAEAEA] mb-6 font-semibold">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="relative">
              <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-[#D4AF37] shadow-[0_0_20px_rgba(212,175,55,0.2)]">
                <img
            ...
            {/* Name */}
            <h4 className="text-xl text-[#D4AF37] mt-6 font-semibold">
              Shyam Yemuka
            </h4>
            <p className="text-[#B0B0B0] text-sm mt-1">Creator & Developer</p>
          </div>
          ...
          <div className="lg:pl-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-sm text-[#707070]">Name</p>
                  <p className="text-[#EAEAEA]">Shyam Yemuka</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-sm text-[#707070]">Email</p>
                  <a
                    href="mailto:StudentLMSofficial@gmail.com"
                    className="text-[#EAEAEA] hover:text-[#D4AF37] transition-colors">
